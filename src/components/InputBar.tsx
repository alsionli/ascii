    ...
    <div className="w-full max-w-[620px] mx-auto px-4">
      <div className="relative flex items-center">
        <input
          ...
          disabled={loading}
          className="w-full bg-white/[0.04] border border-white/[0.08] rounded-full py-3.5 pl-5 pr-12 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-white/20 focus:bg-white/[0.06] transition-all disabled:opacity-50"
        />
        {loading ? (
          <button
            onClick={onStop}
